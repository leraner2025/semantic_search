...
from prompts.intent_extraction import INTENT_EXTRACTION_PROMPT
...
class ContextualIntentPipeline:
    ...
    def _call_model(self, prompt: str, temperature: float = 0.0, max_tokens: int = 2048) -> str:
        """
        Calls Google Generative AI Studio model to generate text.
        """
        try:
...
if __name__ == "__main__":
    pipeline = ContextualIntentPipeline(enable_refinement=False)
